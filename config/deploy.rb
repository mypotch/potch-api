...
set :shared_files, fetch(:shared_files, []).push('config/database.yml', 'config/application.yml', 'config/master.key', 'config/puma.rb')
...
task :setup do
  ...
  comment "Be sure to edit '#{fetch(:shared_path)}/config/database.yml', 'master.key', 'application.yml' and puma.rb."
end
...
#
# mina 'rake[db:seed]' on=production
